...
// Return Type  : void
//
void emxFree_real32_T(FloatArray **pEmxArray)
{
  if (*pEmxArray != (FloatArray *)NULL) {
...
// Return Type  : void
//
void emxInit_real32_T(FloatArray **pEmxArray, int numDimensions)
{
  FloatArray *emxArray;
  int i;
  *pEmxArray = (FloatArray *)malloc(sizeof(FloatArray));
  emxArray = *pEmxArray;
...
// Return Type  : void
//
void emxInit_real32_T1(FloatArray **pEmxArray, int numDimensions)
{
  FloatArray *emxArray;
  int i;
  *pEmxArray = (FloatArray *)malloc(sizeof(FloatArray));
